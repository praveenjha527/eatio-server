...
class Notification(models.Model):
    ...
    NOTIFICATION_TYPE_AGREE = 'AGREE'
    NOTIFICATION_TYPE_DIS_AGREE = 'DIS_AGREE'
    ...
    NOTIFICATION_TYPE_CHOICES = (
        ...
        (NOTIFICATION_TYPE_AGREE, NOTIFICATION_TYPE_AGREE),
        (NOTIFICATION_TYPE_DIS_AGREE, NOTIFICATION_TYPE_DIS_AGREE),
    )
